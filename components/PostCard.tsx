  ...
  return (
    <Link href={`/${post.slug}`} className="group flex flex-col overflow-hidden rounded-xl border border-gray-100 bg-white shadow-sm transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
      <div className="relative aspect-[4/3] w-full overflow-hidden bg-gray-100">
        ...
        />
        {category && (
          <span className="absolute left-4 top-4 rounded-full bg-[#FF6B35] px-3 py-1 text-xs font-medium text-white backdrop-blur-sm shadow-sm">
      ...
      <div className="flex flex-1 flex-col p-5">
        ...
        <h3 className="mb-2 text-lg font-bold leading-tight text-gray-900 group-hover:text-gray-700 line-clamp-2">
